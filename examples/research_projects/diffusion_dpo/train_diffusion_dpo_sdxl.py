...
def tokenize_captions(tokenizers, examples):
    ...
    tokens_one = tokenizers[0](
        captions, truncation=True, padding="max_length", max_length=tokenizers[0].max_length, return_tensors="pt"
    ).input_ids
    tokens_two = tokenizers[1](
        captions, truncation=True, padding="max_length", max_length=tokenizers[1].max_length, return_tensors="pt"
    ).input_ids
