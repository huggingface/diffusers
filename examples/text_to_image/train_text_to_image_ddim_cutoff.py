...
import sys
_project_dir_ = os.path.dirname(os.path.dirname(os.path.dirname(__file__)))
...
def main():
    ...
    def collate_fn(examples):
        ...
        caption_columns = [example[caption_column] for example in examples]
        return {"pixel_values": pixel_values, "input_ids": input_ids, "caption_columns": caption_columns}
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                encoder_hidden_states = cutoff_text_encoder(
                    batch["caption_columns"],
                    text_encoder,
                    tokenizer,
