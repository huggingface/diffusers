...
def random_irregular_mask_generator(
        img, max_angle=4, max_len=60, 
        max_width=20, min_times=0, max_times=10, ramp_kwargs=None,
    ...
    return make_random_irregular_mask(img.shape[1:], max_angle=max_angle, max_len=cur_max_len,
...
class MixedMaskGenerator:
    def __init__(self, irregular_proba=1/3, irregular_kwargs=None,
        ...
        # TODO - additional image segmentation dependency, can we get away with not using
        # if segm_proba > 0:
...
def make_wds_inpainting_dataset(
    ...
    def mapper(d):
        ...
        # TODO - bad, really only need to pass shape info
        mask = mask_generator(pixel_values)
