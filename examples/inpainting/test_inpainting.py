...
from diffusers import StableDiffusionInpaintPipeline, UNet2DConditionModel  # noqa: E402
...
class Inpainting(ExamplesTestsAccelerate):
    ...
    def test_inpainting_checkpointing(self):
        pretrained_model_name_or_path = "hf-internal-testing/tiny-sd-pipe"
        prompt = "a prompt"
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            pipe = StableDiffusionInpaintPipeline.from_pretrained(tmpdir, safety_checker=None)
    ...
    def test_inpainting_checkpointing_use_ema(self):
        pretrained_model_name_or_path = "hf-internal-testing/tiny-stable-diffusion-pipe"
        prompt = "a prompt"
        init_image = load_image(
            "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/diffusers/inpaint.png"
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            pipe = StableDiffusionInpaintPipeline.from_pretrained(tmpdir, safety_checker=None)
            pipe(prompt, image=init_image, mask_image=mask, num_inference_steps=2)
    ...
    def test_inpainting_checkpointing_checkpoints_total_limit(self):
        pretrained_model_name_or_path = "hf-internal-testing/tiny-stable-diffusion-pipe"
        prompt = "a prompt"
        init_image = load_image(
            "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/diffusers/inpaint.png"
    ...
    def test_inpainting_checkpoints_total_limit_removes_multiple_checkpoints(self):
        pretrained_model_name_or_path = "hf-internal-testing/tiny-stable-diffusion-pipe"
        prompt = "a prompt"
        init_image = load_image(
            "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/diffusers/inpaint.png"
