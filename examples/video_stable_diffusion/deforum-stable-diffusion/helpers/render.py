    ...
    while frame_idx < anim_args.max_frames:
            ...
            for tween_frame_idx in range(tween_frame_start_idx, frame_idx):
                ...
                if args.use_mask and args.overlay_mask:
                    ...
                    init_image_raw, _ = anim_frame_warp(
                        args.init_sample_raw, args, anim_args, keys, frame_idx, depth_model, depth, device=root.device
                    )
                ...
                if args.use_mask:
                    ...
                    mask_image, _ = anim_frame_warp(
                        args.mask_sample, args, anim_args, keys, frame_idx, depth_model, depth, device=root.device
                    )
                    if root.half_precision:
                ...
                if anim_args.save_depth_maps:
                    depth_model.save(
                        os.path.join(args.outdir, f"{args.timestring}_depth_{tween_frame_idx:05}.png"), depth
                    )
        ...
        if prev_sample is not None:
            prev_img, depth = anim_frame_warp(
                prev_sample, args, anim_args, keys, frame_idx, depth_model, depth=None, device=root.device
            )
