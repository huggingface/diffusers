...
def main():
    ...
    p.add_argument("--images-dir", type=str, required=True, help="the dataset images directory")
    ...
    obj = {"clip_model": args.clip_model, "embeds": torch.cat(embeds), "ratings": torch.cat(ratings)}
