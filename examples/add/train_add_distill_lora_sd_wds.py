...
def main(args):
    ...
    # 6. Initialize GAN generator U-Net from SD 1.X/2.X checkpoint with the teacher U-Net's pretrained weights
    ...
    # 13. Optimizer creation for generator and discriminator
    ...
    # 14. Dataset creation and data processing
