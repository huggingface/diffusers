...
MODEL_PATH = "Boogu/Boogu-Image-0.1-Turbo-fp8"
...
pipe = BooguImageTurboPipeline.from_pretrained(MODEL_PATH, torch_dtype=torch.bfloat16, transformer=transformer)
pipe = pipe.to("cuda")
...
assert len(images) == 1
images[0].save("turbo_fp8.png")
print("Inference OK, saved turbo_fp8.png")
