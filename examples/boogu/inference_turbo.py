...
MODEL_PATH = "Boogu/Boogu-Image-0.1-Turbo"

pipe = BooguImageTurboPipeline.from_pretrained(MODEL_PATH, torch_dtype=torch.bfloat16)
pipe = pipe.to("cuda")
...
assert len(images) == 1
images[0].save("turbo.png")
print("Inference OK, saved turbo.png")
