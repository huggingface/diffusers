...
The `train_t2i_adapter_sdxl.py` script shows how to implement the T2IAdapter training procedure for [Stable Diffusion XL](https://huggingface.co/papers/2307.01952).
