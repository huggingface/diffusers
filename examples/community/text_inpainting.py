...
class TextInpainting(DiffusionPipeline):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        inputs = self.segmentation_processor(text=[text], images=[image], padding="max_length", return_tensors="pt")
        ...
        inpainting_res = self.inpainting_pipeline(
            prompt=prompt,
            image=image,
            mask_image=mask_pil,
            height=height,
