...
This is the Diffusers implementation of zero-shot video-to-video translation pipeline [Rerender_A_Video](https://github.com/williamyang1991/Rerender_A_Video) (without Ebsynth postprocessing). To run the code, please install gmflow and download checkpoint `gmflow_sintel-0c07dcb3.pth`. Then modify the path in `examples/community/rerender_a_video.py`:
...
export_to_video(
    output_frames, "/home/yfzhou/repo/diffusers-Rerender/logs/tmp.mp4", 5)
