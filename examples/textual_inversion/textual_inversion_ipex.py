...
def parse_args():
    ...
    parser.add_argument(
        "--use_bf16", action="store_true", default=False, help="Use bfloat16 on Xeon Scalable Processor."
    )
    parser.add_argument(
...
def main():
    ...
    if args.use_bf16:
        ...
        text_encoder, optimizer = ipex.optimize(text_encoder, optimizer=optimizer)
