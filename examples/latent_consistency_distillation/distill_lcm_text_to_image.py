...
def parse_args():
    ...
    parser.add_argument(
        ...
        help=(
            ...
            " as `None`. If left as `None` the default prediction type of the scheduler:"
    ...
    parser.add_argument(
        ...
        type=str,
        default="ddim",
        help="The ODE solver to use to estimate the next step on the (augmented) PF-ODE trajectory.",
    )
    parser.add_argument("--k", type=int, default=20, help="The k or skipping interval parameter from the LCM paper.")
    parser.add_argument(
        "--w_min",
        type=float,
        default=2.0,
...
def main():
    ...
    # 1. Set up logging and accelerator
    ...
    # 5. Enable TF32 for faster training on Ampere GPUs.
    # cf https://pytorch.org/docs/stable/notes/cuda.html#tensorfloat-32-tf32-on-ampere-devices
    if args.allow_tf32:
        torch.backends.cuda.matmul.allow_tf32 = True

    # 6. Set up initial learning rate and optimizer.
    if args.scale_lr:
        args.learning_rate = (
    ...
    # 7. Load and set up the dataset for distillation
    ...
    # 10. Create the learning rate scheduler.
    ...
    # 11. Prepare everything with our `accelerator`.
    ...
    # 13. Move models to device and cast to desired dtype
    ...
    # 16.1. Potentially load in the weights and states from a previous save
    ...
    # 17. Create the pipeline using the trained modules and save it.
