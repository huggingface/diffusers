...
def save_model_card(
    ...
    model_description = f"""
# Playground LoRA DreamBooth - {repo_id}
...
def main(args):
    ...
    # Computes additional embeddings/ids required by the UNet.
    ...
    if accelerator.is_main_process:
        accelerator.init_trackers("dreambooth-lora-playground", config=vars(args))
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        if accelerator.is_main_process:
            if args.validation_prompt is not None and epoch % args.validation_epochs == 0:
                ...
                pipeline_args = {"prompt": args.validation_prompt, "num_inference_steps": 25, "guidance_scale": 5}
