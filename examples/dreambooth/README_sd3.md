...
> [!NOTE]  
> If you want to train the T5 text encoder using long prompts, you can use `--max_sequence_length` to set the token limit. The default is 77, but it can be increased to as high as 512. Note that this will use more resources and may slow down the training in some cases.
