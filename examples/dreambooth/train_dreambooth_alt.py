...
from diffusers import AutoencoderKL, DDPMScheduler, StableDiffusionPipeline, UNet2DConditionModel, AltDiffusionPipeline
...
# pakage for RobertaSeriesModelWithTransformation
