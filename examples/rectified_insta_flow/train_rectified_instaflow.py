...
def log_validation(vae, text_encoder, tokenizer, unet, args, accelerator, weight_dtype, epoch, distill=False):
...
def parse_args():
    ...
    # Sanity checks
    if args.generated_dataset_name is None and args.dataset_name is None and args.train_data_dir is None:
        raise ValueError("Need either a generated ataset name or a dataset name or a training folder.")
...
def main():
    ...
    unet = None
    for i in range(args.num_reflow_steps):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet):
                ...
                if args.snr_gamma is None:
                    ...
                    # Technically, MinSNR is not tested with rectified flows yet but it should work
