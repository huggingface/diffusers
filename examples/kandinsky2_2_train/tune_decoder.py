...
def main():
    ...
    unet = UNet2DConditionModel.from_pretrained(args.pretrained_kandinsky_path, subfolder="unet")
    ...
    if args.use_ema:
        ema_unet = UNet2DConditionModel.from_pretrained(args.pretrained_kandinsky_path, subfolder="unet")
