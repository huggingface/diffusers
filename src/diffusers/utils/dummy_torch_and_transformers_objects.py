...
class Cosmos2_5_PredictImage2World(metaclass=DummyObject):
    _backends = ["torch", "transformers"]
...
class Cosmos2_5_PredictText2World(metaclass=DummyObject):
    _backends = ["torch", "transformers"]
...
class Cosmos2_5_PredictVideo2World(metaclass=DummyObject):
    _backends = ["torch", "transformers"]
