...
class WuerstchenV3CombinedPipeline(metaclass=DummyObject):
    _backends = ["torch", "transformers"]
...
class WuerstchenV3DecoderPipeline(metaclass=DummyObject):
    _backends = ["torch", "transformers"]
...
class WuerstchenV3PriorPipeline(metaclass=DummyObject):
    _backends = ["torch", "transformers"]
