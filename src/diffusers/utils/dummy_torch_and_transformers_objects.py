...
class EchoWMBlocks(metaclass=DummyObject):
    _backends = ["torch", "transformers"]
...
class EchoWMFlashBlocks(metaclass=DummyObject):
    _backends = ["torch", "transformers"]
...
class EchoWMFlashModularPipeline(metaclass=DummyObject):
    _backends = ["torch", "transformers"]
...
class EchoWMModularPipeline(metaclass=DummyObject):
    _backends = ["torch", "transformers"]
