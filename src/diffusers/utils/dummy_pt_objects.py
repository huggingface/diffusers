...
class PatchedTransformer2DModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class ContinuousTransformer2DModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class VectorizedTransformer2DModel(metaclass=DummyObject):
    _backends = ["torch"]
