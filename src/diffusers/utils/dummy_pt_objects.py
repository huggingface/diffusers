...
class BooguImageTransformer2DModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class PromptEmbedding(metaclass=DummyObject):
    _backends = ["torch"]
...
class BooguFlowMatchEulerDiscreteScheduler(metaclass=DummyObject):
    _backends = ["torch"]
