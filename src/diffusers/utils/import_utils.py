...
_comfy_quant_available, _comfy_quant_version = _is_package_available("comfy_kitchen")
...
def is_comfy_quant_available():
    return _comfy_quant_available
...
BACKENDS_MAPPING = OrderedDict(
    [
        ...
        ("comfy_kitchen", (is_comfy_quant_available, COMFY_QUANT_IMPORT_ERROR)),
