...
class StableDiffusionInpaintOnnxPipeline(DiffusionPipeline):
    r"""
    ...
    def __init__(
        ...
        super().__init__()
        logger.info("`StableDiffusionInpaintOnnxPipeline` is experimental and will very likely change in the future.")
    ...
    def __call__(
        ...
        init_latents = np.concatenate([init_latents.detach().numpy()] * batch_size)
        ...
        mask = np.concatenate([mask_image.detach().numpy()] * batch_size)
