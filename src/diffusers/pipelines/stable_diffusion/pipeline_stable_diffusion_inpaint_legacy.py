...
class StableDiffusionInpaintPipelineLegacy(DiffusionPipeline):
    ...
    def __call__(
        ...
        """
        # 1. Check inputs
        self.check_inputs(prompt, strength, callback_steps, prompt_embeds = prompt_embeds)

        # 2. Define call parameters
        batch_size = 1 if isinstance(prompt, str) or prompt_embeds is not None else len(prompt)
