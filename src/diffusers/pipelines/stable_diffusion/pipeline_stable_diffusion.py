...
class CoreStableDiffusionPipeline(DiffusionPipeline):
    ...
    def _run_safety_checker(self, image):
        # run safety checker
    ...
    def _get_text_embeddings(self, prompt, batch_size, guidance_scale, negative_prompt):
        ...
        return text_embeddings, do_classifier_free_guidance
