    ...
    def __call__(
        ...
        Args:
            ...
            pooled_prompt_embeds (`torch.Tensor`, *optional*):
                ...
                not provided, pooled text embeddings are generated from the `prompt` input argument.
            negative_pooled_prompt_embeds (`torch.Tensor`, *optional*):
                Pre-generated negative pooled text embeddings. Can be used to easily tweak text inputs (prompt
                weighting). If not provided, pooled `negative_prompt_embeds` are generated from the `negative_prompt`
                input argument.
