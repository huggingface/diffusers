...
from ...models import ImageProjection, UNet2DConditionModel
...
from ...schedulers import EulerAncestralDiscreteXPredScheduler
from ...utils import (
    USE_PEFT_BACKEND,
    deprecate,
    ...
    def encode_prompt(
        ...
        if prompt_embeds is None:
            ...
            for prompt, tokenizer, text_encoder in zip(prompts, tokenizers, text_encoders):
                ...
                prompt_embeds, pooled_output = text_encoder(text_input_ids.to(device), attention_mask.to(device))
