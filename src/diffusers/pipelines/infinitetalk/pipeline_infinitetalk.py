...
from .pipeline_output import InfiniteTalkPipelineOutput
...
class InfiniteTalkPipeline(DiffusionPipeline, WanLoraLoaderMixin):
    r"""
    ...
    def __init__(
        ...
        audio_processor: Wav2Vec2Processor = None,
        audio_encoder: Wav2Vec2Model = None,
    ...
    def __call__(
        ...
        return InfiniteTalkPipelineOutput(frames=video)
