...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> from diffusers import AutoPipelineForImage2Image, ControlNetModel, UniPCMultistepScheduler
        ...
        ...     "runwayml/stable-diffusion-v1-5", controlnet=controlnet, enable_pag=True, torch_dtype=torch.float16
        ... )
