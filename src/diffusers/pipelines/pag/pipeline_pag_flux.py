...
from diffusers.loaders import FluxLoraLoaderMixin, FromSingleFileMixin, FluxLoraLoaderMixin
...
from diffusers.models.attention_processor import PAGFluxAttnProcessor_2_0, PAGCFGFluxAttnProcessor_2_0 
...
class FluxPAGPipeline(DiffusionPipeline, FluxLoraLoaderMixin, FromSingleFileMixin):
    r"""
    ...
    def encode_prompt(
        ...
        if lora_scale is not None and isinstance(self, FluxLoraLoaderMixin):
            ...
            if self.text_encoder and USE_PEFT_BACKEND:
                scale_lora_layers(self.text_encoder, lora_scale)
            if self.text_encoder_2 and USE_PEFT_BACKEND:
        ...
        # Unscale LoRA
        if self.text_encoder and isinstance(self, FluxLoraLoaderMixin) and USE_PEFT_BACKEND:
        ...
        if true_pag_scale > 0:
            for name, module in self.transformer.named_modules():
                if isinstance(module, Attention):
                    if do_true_cfg:
                        module.processor = PAGCFGFluxAttnProcessor_2_0()
                    else:
                        module.processor = PAGFluxAttnProcessor_2_0()
