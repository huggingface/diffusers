...
class AudioLDM2Pipeline(DiffusionPipeline):
    ...
    def prepare_latents(self, batch_size, num_channels_latents, height, dtype, device, generator, latents=None):
        ...
        scaled down dimensions of input `height` and `self.vocoder.config.model_in_dim`, and have a type of passed `dtype` on provided `device`.
        ...
        Args:
            ...
            self.vocoder.config.model_in_dim (`int`):
