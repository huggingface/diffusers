...
class BriaFiboPipeline(DiffusionPipeline):
    ...
    @staticmethod
    # Based on https://github.com/huggingface/diffusers/blob/main/src/diffusers/pipelines/flux/pipeline_flux.py
    ...
    @staticmethod
    # Based on https://github.com/huggingface/diffusers/blob/main/src/diffusers/pipelines/qwenimage/pipeline_qwenimage.py
