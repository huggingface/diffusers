...
class NewbiePipeline(Lumina2Pipeline):
    ...
    def check_inputs(
        ...
        if max_sequence_length is not None and max_sequence_length > 8192:
            raise ValueError(f"`max_sequence_length` cannot be greater than 8192 but is {max_sequence_length}")
