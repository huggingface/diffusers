...
try:
    ...
    _import_structure["pipeline_ltx2_hdr_lora"] = ["LTX2HDRLoraPipeline", "LTX2HDRReferenceCondition"]
    _import_structure["pipeline_ltx2_ic_lora"] = ["LTX2ICLoraPipeline", "LTX2ReferenceCondition"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_ltx2_ic_lora import LTX2ICLoraPipeline, LTX2ReferenceCondition
