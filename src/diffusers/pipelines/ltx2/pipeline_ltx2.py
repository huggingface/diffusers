...
from .utils import GEMMA3_PROMPT_ENHANCEMENT_CONFIG, GEMMA4_PROMPT_ENHANCEMENT_CONFIG, LTX2_5_T2V_DEFAULT_SYSTEM_PROMPT
...
class LTX2Pipeline(DiffusionPipeline, FromSingleFileMixin, LTX2LoraLoaderMixin):
    ...
    def enhance_prompt(
        ...
        one is configured (e.g. LTX-2.5, whose text encoder isn't trained for enhancement), otherwise falls back to the
