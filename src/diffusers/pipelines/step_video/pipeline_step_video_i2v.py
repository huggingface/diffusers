...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> import torch
        >>> import numpy as np
        >>> from diffusers import AutoencoderKLStepVideo, StepVideoImageToVideoPipeline
        >>> from diffusers.utils import export_to_video, load_image
        >>> from transformers import CLIPVisionModel

        >>> # Available models: stepfun-ai/stepvideo-ti2v-30B-480P-Diffusers, stepfun-ai/stepvideo-ti2v-30B-720P-Diffusers
        >>> model_id = "stepfun-ai/stepvideo-ti2v-30B-480P-Diffusers"
        >>> image_encoder = CLIPVisionModel.from_pretrained(
        ...     model_id, subfolder="image_encoder", torch_dtype=torch.float32
        ... )
        >>> vae = AutoencoderKLStepVideo.from_pretrained(model_id, subfolder="vae", torch_dtype=torch.float32)
        >>> pipe = StepVideoImageToVideoPipeline.from_pretrained(
...
class StepVideoImageToVideoPipeline(DiffusionPipeline, StepVideoLoraLoaderMixin):
    r"""
    Pipeline for image-to-video generation using StepVideo.
    ...
    Args:
        ...
        image_encoder ([`CLIPVisionModel`]):
            ...
            variant.
        transformer ([`StepVideoTransformer3DModel`]):
    ...
    def __init__(
        ...
        transformer: StepVideoTransformer3DModel = None,
