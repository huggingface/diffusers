...
"./stable-diffusion". To correctly retrieve which models and components should be loaded, one has to provide a `model_index.json` file, *e.g.* [runwayml/stable-diffusion-v-1-5/model_index.json](https://huggingface.co/runwayml/stable-diffusion-v-1-5/blob/main/model_index.json), which defines all components that should be 
