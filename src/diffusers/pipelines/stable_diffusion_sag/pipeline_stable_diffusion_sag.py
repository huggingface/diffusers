...
class CrossAttnStoreProcessor2_0:
    def __init__(self):
...
class StableDiffusionSAGPipeline(DiffusionPipeline, TextualInversionLoaderMixin, IPAdapterMixin):
    ...
    def __call__(
        ...
        # 7. Denoising loop
        store_processor = (
            CrossAttnStoreProcessor2_0() if hasattr(F, "scaled_dot_product_attention") else CrossAttnStoreProcessor()
        )
                ...
                for i, t in enumerate(timesteps):
                    ...
                    if do_self_attention_guidance:
                        ...
                        if do_classifier_free_guidance:
                            ...
                            uncond_attn, cond_attn = store_processor.attention_map.chunk(2)
