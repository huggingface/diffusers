# Copied from https://github.com/huawei-noah/Speech-Backbones/blob/main/Grad-TTS/model/text_encoder.py with minimial changes
# The first 5 functions are copied from https://github.com/huawei-noah/Speech-Backbones/blob/main/Grad-TTS/model/utils.py
