...
def is_safetensors_compatible(filenames, variant=None) -> bool:
    ...
    - The model is safetensors compatible only if there is a matching safetensors file
    for every default pytorch file.
    ...
    for filename in pt_filenames:
        ...
        if variant is None and filename == "pytorch_model":
            filename = "model"
        elif variant is not None and filename == f"pytorch_model.{variant}":
