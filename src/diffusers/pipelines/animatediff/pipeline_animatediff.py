...
class AnimateDiffPipeline(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin):
    ...
    def decode_latents(self, latents):
        ...
        video = output[None, :].reshape(batch_size, num_frames, channels, height, width).permute(0, 2, 1, 3, 4)
    ...
    # Copied from diffusers.pipelines.text_to_video_synthesis.TextToVideoSDPipeline.prepare_latents
    def prepare_latents(
