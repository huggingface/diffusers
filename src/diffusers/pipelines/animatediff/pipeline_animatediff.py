...
from .freeinit_utils import FreeInitMixin
...
class AnimateDiffPipeline(
    ...
    The pipeline also inherits the following loading methods:
        ...
        - [`~pipelines.animatediff.FreeInitMixin.enable_free_init`] for enabling the FreeInit mechanism for generation
        - [`~pipelines.animatediff.FreeInitMixin.disable_free_init`] for disabling the FreeInit mechanism for generation
