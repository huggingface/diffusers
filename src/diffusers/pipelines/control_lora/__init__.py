...
try:
    ...
    _import_structure["pipeline_control_lora_sd_xl"] = ["StableDiffusionXLControlLoRAPipeline"]
try:
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_control_lora_sd_xl import StableDiffusionXLControlNetPipeline
