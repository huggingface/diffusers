# Written by Jinbin Bai in Aug 2023. If you have any question, contact jinbin5bai@gmail.com
...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> image = pipe(
        ...     prompt=prompt, image=init_image, mask_image=mask_image, controlnet_conditioning_image, num_inference_steps=50, strength=0.80
        ... ).images[0]

        >>> image.save("bai_sdxl_controlnet_inpaint.png")
...
class StableDiffusionXLControlNetInpaintPipeline(DiffusionPipeline, LoraLoaderMixin, FromSingleFileMixin):
    ...
    Pipeline for text-to-image generation using Stable Diffusion XL and ControlNet.
    ...
    def __call__(
        ...
        # 1. Check inputs #TODO check mask_image and controlnet_conditioning_image
        self.check_inputs(
            prompt,
            prompt_2,
            height,
