...
class QwenImageEditControlNetPipeline(DiffusionPipeline, QwenImageLoraLoaderMixin):
    r"""
    ...
    def __call__(
        ...
        Args:
            ...
            controlnet_conditioning_scale (`float` or `List[float]`, *optional*, defaults to 1.0):
                ...
                to the residual in the original transformer. If multiple ControlNets are specified in `init`, you can
                set the corresponding scale as a list.
        ...
        latents_shape = (1, height // self.vae_scale_factor // 2, width // self.vae_scale_factor // 2)
        image_latents_shape = (
            1,
            calculated_height // self.vae_scale_factor // 2,
            calculated_width // self.vae_scale_factor // 2,
        )
        img_shapes = [[latents_shape, image_latents_shape]] * batch_size
        control_net_img_shapes = [latents_shape] * batch_size
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                controlnet_block_samples = self.controlnet(
                    ...
                    img_shapes=control_net_img_shapes,
