    ...
    def __call__(
        ...
        **kwargs,
        ...
        if guidance_scale != 1.0:
            ...
            negative_prompt_embeds = self.bert(uncond_input.input_ids.to(self._execution_device)).last_hidden_state

        # get prompt text embeddings
        text_input = self.tokenizer(prompt, padding="max_length", max_length=77, truncation=True, return_tensors="pt")
        prompt_embeds = self.bert(text_input.input_ids.to(self._execution_device)).last_hidden_state
