...
from ...utils import deprecate, logging, default_encode_prompt_sd
...
class StableDiffusionKDiffusionPipeline(
    ...
    def __init__(
        ...
        self._prompt_encoder = default_encode_prompt_sd
    ...
    def set_prompt_encoder(self, encoder: Callable):
    ...
    def encode_prompt(
        ...
        """
        return self._prompt_encoder(self, prompt, device,
                                    num_images_per_prompt,
                                    do_classifier_free_guidance,
                                    negative_prompt=negative_prompt,
                                    prompt_embeds=prompt_embeds,
