...
try:
    ...
    _import_structure["z_image"] = ["ZImageImg2ImgPipeline", "ZImagePipeline", "ZImageOmniPipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    ...
    try:
        ...
        from .z_image import ZImageImg2ImgPipeline, ZImagePipeline, ZImageOmniPipeline
