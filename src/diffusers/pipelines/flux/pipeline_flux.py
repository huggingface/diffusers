    ...
    def __call__(
        ...
        Args:
            ...
            latents (`torch.FloatTensor`, *optional*):
                ...
                tensor will ge generated by sampling using the supplied random `generator`. Note: This pipeline expects 
                `latents` to be in a packed format. If you're providing custom latents, make sure to use the 
                `_pack_latents` method to prepare them. Packed latents should be a 3D tensor of shape 
