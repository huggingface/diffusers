...
from . import MultiDiffusionText2PanoramaPipelineOutput, StableDiffusionSafetyChecker
...
class MultiDiffusionText2PanoramaPipeline(DiffusionPipeline):
    r"""
    ...
    # Credits to Omer Bar Tal for this method.
    ...
    def __call__(
        ...
        return MultiDiffusionText2PanoramaPipelineOutput(images=image, nsfw_content_detected=has_nsfw_concept)
