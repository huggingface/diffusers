# Copyright 2025 victolee0, The HuggingFace Team and The ostris Team. All rights reserved.
#
...
class Flex2Pipeline(DiffusionPipeline, FluxLoraLoaderMixin, FromSingleFileMixin, FluxIPAdapterMixin):
    r"""
    The Flex pipeline for text-to-image generation.

    Reference: https://huggingface.co/ostris/Flex.2-preview
    ...
    def __call__(
        ...
        Returns:
            [`~pipelines.flex2.Flex2PipelineOutput`] or `tuple`: [`~pipelines.flex2.Flex2PipelineOutput`] if `return_dict`
