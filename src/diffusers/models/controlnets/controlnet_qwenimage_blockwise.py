...
@dataclass
class QwenImageBlockControlNetOutput(BaseOutput):
...
class QwenImage_Blockwise_Controlnet(ModelMixin, ConfigMixin, PeftAdapterMixin, FromOriginalModelMixin, CacheMixin):
