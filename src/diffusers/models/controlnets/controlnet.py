...
from ...loaders import PeftAdapterMixin, ControlNetLoadersMixin
...
class ControlNetModel(ModelMixin, ConfigMixin, FromOriginalModelMixin, ControlNetLoadersMixin, PeftAdapterMixin):
    """
    A ControlNet model.
