...
from ..transformers.transformer_cogview4 import CogView4TransformerBlock,CogView4PatchEmbed
...
class SD3ControlNetModel(ModelMixin, ConfigMixin, PeftAdapterMixin, FromOriginalModelMixin):
    ...
    def __init__(
        ...
        self.pos_embed = CogView4PatchEmbed(
