...
from .unet_new import get_down_block, get_up_block
...
#            down_block_type = "UNetResAttnDownBlock2D" if ds_new in attention_resolutions else "UNetResDownBlock2D"
        ...
        for i, (input_channel, output_channel) in enumerate(zip(reversed(input_channels), reversed(output_channels))):
            ...
            is_final_block = i == len(input_channels) - 1
#            up_block_type = "UNetResAttnUpBlock2D" if ds_new in attention_resolutions else "UNetResUpBlock2D"
