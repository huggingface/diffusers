...
Fuses text, lyric, and timbre conditioning into the packed sequence used by the DiT's cross-attention. The internal
``AceStepEncoderLayer`` block is duplicated here (and in :mod:`diffusers.models.autoencoders.audio_tokenizer_ace_step`)
to keep the two model files independent.
"""
