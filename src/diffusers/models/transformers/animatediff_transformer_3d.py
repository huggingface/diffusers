...
# TODO(aryan): Should we have the (ModelMixin, ConfigMixin) here, or is this as per what you meant in our chat?
class AnimateDiffTransformer3DModel(nn.Module):
    ...
    # TODO(aryan): Since we removed ConfigMixin, this isn't required anymore too unless I interpreted our message incorrectly
    # @register_to_config
    def __init__(
        self,
