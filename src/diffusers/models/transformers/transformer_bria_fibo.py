...
# Based on from diffusers.models.transformers.transformer_flux.FluxAttnProcessor
...
# Based on from diffusers.models.transformers.transformer_flux.FluxAttention
