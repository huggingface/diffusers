...
from diffusers.models import flash_attention
...
class BasicTransformerBlock(nn.Module):
    ...
    def set_flash_attention(self, enable_flash_attention: bool) -> None:
        self.attn1.use_flash_attention = enable_flash_attention
        self.attn2.use_flash_attention = enable_flash_attention
        ...
        if not is_xformers_available():
            ...
            try:
                ...
                _ = xformers.ops.memory_efficient_attention(
                    torch.randn((1, 2, 20), device="cuda"),
                    torch.randn((1, 2, 20), device="cuda"),
                    torch.randn((1, 2, 20), device="cuda"),
                )
...
class CrossAttention(nn.Module):
    ...
    def forward(self, hidden_states, context=None, mask=None):
        ...
        if self.use_flash_attention and query.shape[-1] <= 128:
            hidden_states = flash_attention.attention3D(query, key, value, self.scale)
