...
class UNetMidBlock3DCrossAttn(nn.Module):
    def __init__(
        ...
        print(f"Number of attention heads ({self.__class__.__name__}): {in_channels // num_attention_heads}")
...
class CrossAttnDownBlock3D(nn.Module):
    def __init__(
        ...
        print(f"Number of attention heads ({self.__class__.__name__}) {out_channels // num_attention_heads}")
