    ...
    def __call__(
        ...
        if encoder_hidden_states is not None: 
            if img_mask is not None:
                ...
                txt_mask_downsample[txt_mask_downsample < torch.max(txt_mask_downsample)] *= (2.0 - img_ratio)
                ...
                img_mask_downsample[img_mask_downsample < torch.max(img_mask_downsample)] *= img_ratio
