...
@dataclass
class ValueFunctionSchedulerOutput(BaseOutput):
    """
...
class ValueFunctionScheduler(SchedulerMixin, ConfigMixin):
    """
    ...
    def step(
    ...
    ) -> Union[ValueFunctionSchedulerOutput, Tuple]:
        """
        ...
        return ValueFunctionSchedulerOutput(prev_sample=pred_prev_sample, pred_original_sample=pred_original_sample)
