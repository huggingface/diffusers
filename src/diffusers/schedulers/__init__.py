...
try:
    ...
    _import_structure["scheduling_discrete_ddim"] = ["DiscreteDDIMScheduler"]
    ...
    _import_structure["scheduling_entropy_bound"] = ["EntropyBoundScheduler"]
    ...
    _import_structure["scheduling_uniform_refinement"] = ["UniformRefinementScheduler"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    ...
    try:
        ...
        from .scheduling_entropy_bound import EntropyBoundScheduler
        ...
        from .scheduling_uniform_refinement import UniformRefinementScheduler
