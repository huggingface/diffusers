...
try:
    ...
    _import_structure["scheduling_stochastic_rf_discrete_overshot"] = ["StochasticRFOvershotDiscreteScheduler"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    ...
    try:
        ...
        from .scheduling_stochastic_rf_discrete_overshot import StochasticRFOvershotDiscreteScheduler
