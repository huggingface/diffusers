...
@dataclass
# Copied from diffusers.schedulers.scheduling_ddpm.DDPMSchedulerOutput with DDPM->FlowMatchEulerDiscreteCosmos2_0
class FlowMatchEulerEDMCosmos2_0SchedulerOutput(BaseOutput):
    """
...
class FlowMatchEulerEDMCosmos2_0Scheduler(SchedulerMixin, ConfigMixin):
    """
    Implements the Rectified Flow matching scheduler with EDM formulation as presented in Karras et al. 2022 [1].
    ...
    def step(
        ...
        pred_original_sample: Optional[torch.Tensor] = None,
    ) -> Union[FlowMatchEulerEDMCosmos2_0SchedulerOutput, Tuple]:
        """
        ...
        Args:
            ...
            return_dict (`bool`):
                ...
                [`~schedulers.scheduling_flow_match_edm_cosmos2.FlowMatchEulerEDMCosmos2_0SchedulerOutput`] or tuple.

        Returns:
            [`~schedulers.scheduling_flow_match_edm_cosmos2.FlowMatchEulerEDMCosmos2_0SchedulerOutput`] or `tuple`:
                If return_dict is `True`,
                [`~schedulers.scheduling_flow_match_edm_cosmos2.FlowMatchEulerEDMCosmos2_0SchedulerOutput`] is
        ...
        if isinstance(timestep, (int, torch.IntTensor, torch.LongTensor)):
            raise ValueError(
                (
                    ...
                    " `FlowMatchEulerEDMCosmos2_0Scheduler.step()` is not supported. Make sure to pass"
        ...
        return FlowMatchEulerEDMCosmos2_0SchedulerOutput(
