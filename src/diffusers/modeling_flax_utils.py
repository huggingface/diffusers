    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        Parameters:
            ...
            return_mapping_dict (`bool`, *optional*, defaults to `False`):
                When used with from_pt, a mapping_dict generated from the PyTorch conversion will be returned, which can be used to save as pt_torch
        ...
        return_mapping_dict = kwargs.pop("return_mapping_dict", False)
        ...
        if from_pt:
            ...
            if return_mapping_dict == True: #Store mapping_dict generated by weight conversion
                state, mapping_dict = convert_pytorch_state_dict_to_flax(pytorch_model_file, model, return_mapping_dict=True)
            else: #Convert weight without storing mapping_dict
        ...
        if return_mapping_dict == True: 
            return model, unflatten_dict(state), mapping_dict

        return model, unflatten_dict(state)

    def save_as_pytorch_bin(
        self,
        ...
        Arguments:
            ...
            mapping_dict (`Union[Dict, OrderedDict]`):
                Generated by from_pretrained when called with return_mapping_dict=True. Stores needed info to revert PyTorch to Flax conversion.
        """
        ...
        if is_torch_available():
            import torch
            state_dict = reverse_flax_into_pytorch(params, mapping_dict)
