...
from transformers import T5TokenizerFast, ClapAudioModelWithProjection, RobertaTokenizerFast
...
class TextualInversionLoaderMixin:
    ...
    def _maybe_convert_prompt(self, prompt: str, tokenizer: "PreTrainedTokenizer"):
        ...
        if not isinstance(tokenizer, T5TokenizerFast) and not isinstance(tokenizer, RobertaTokenizerFast):
            for token in tokens:
