...
| [attend_and_excite](./api/pipelines/stable_diffusion/attend_and_excite) | [**Attend and Excite**](https://attendandexcite.github.io/Attend-and-Excite/) | Text-to-Image Generation |
