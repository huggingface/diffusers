...
| [time_diffusion](./api/pipelines/time_diffusion) | [Editing Implicit Assumptions in Text-to-Image Diffusion Models](https://arxiv.org/abs/2303.08084) | Text-to-Image Model Editing |