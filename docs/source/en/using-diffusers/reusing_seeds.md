...
pipe = StableDiffusionPipeline.from_pretrained("Lykon/dreamshaper-8", use_safetensors=True).to("cuda")
...
Let's use the [Lykon/dreamshaper-8](https://huggingface.co/Lykon/dreamshaper-8) checkpoint and generate a batch of images.
