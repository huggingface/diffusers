...
One can also continue fine-tuning from these Diffusers checkpoints by leveraging efficient optimization tools from Diffusers. Refer [here](https://huggingface.co/docs/diffusers/main/en/optimization/fp16) for 
more details.  
