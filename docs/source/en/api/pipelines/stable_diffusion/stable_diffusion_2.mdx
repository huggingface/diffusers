...
For more details about how Stable Diffusion 2 works and how it differs from the original Stable Diffusion, please refer to the official [launch announcement post](https://stability.ai/blog/stable-diffusion-v2-release).
