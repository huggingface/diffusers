...
paper](https://arxiv.org/abs/2302.03027). Below, we also provide a some directions on how to generate the embeddings.
...
edit directions. However, we can also leverage the open-source and the publicly models for this purpose.
