...
The Stable Diffusion model can also be applied to image-to-image generation by passing a text prompt and an initial image to condition the generation of new images. The original codebase can be found at [CompVis/stable-diffusion](https://github.com/CompVis/stable-diffusion/blob/main/scripts/img2img.py).
