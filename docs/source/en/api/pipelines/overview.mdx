...
| [self_segmentation_stable_diffusion](./self_segmentation_stable_diffusion) | [Localizing Object-level Shape Variations with Text-to-Image Diffusion Models](https://arxiv.org/abs/2303.11306) | Text-to-Image Generation, Segmentation |
