...
You can find the original codebase at [Tencent/HunyuanDiT]([https://github.com/PixArt-alpha/PixArt-sigma](https://github.com/Tencent/HunyuanDiT)) and all the available checkpoints at [Tencent-Hunyuan](https://huggingface.co/Tencent-Hunyuan/HunyuanDiT).
