...
pipe_i2i = AutoPipelineForImageToImage.from_pretrained("runwayml/stable-diffusion-v1-5")
```
...
Currently AutoPipeline supports the Text-to-Image, Image-to-Image, and Inpainting tasks for the following diffusion models:
