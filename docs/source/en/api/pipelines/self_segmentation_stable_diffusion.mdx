...
## Available Pipelines:
|---|---|:---:|:---:|
| [self_segmentation_stable_diffusion_pipeline.py](https://github.com/huggingface/diffusers/blob/main/src/diffusers/pipelines/self_segmentation_stable_diffusion_pipeline) | *Text-to-Image Generation, Segmentation* | - | -
