...
LDM3D Image processor does the same as the Image processor for VAE but accepting rgb along with depth inputs and will return rgb and depth outputs. It has the same capabilities than the original image processor for VAE.
