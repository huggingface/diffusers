...
A community pipeline is a class that has to inherit from [`DiffusionPipeline`](https://huggingface.co/docs/diffusers/api/diffusion_pipeline#diffusers.DiffusionPipeline):
and that has been added to [`examples/community`](https://github.com/huggingface/diffusers/tree/main/examples/community).
