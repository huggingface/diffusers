...
- 最先进的扩散pipelines，可以在推理中仅用几行代码运行(详情看[**Using Diffusers**](./using-diffusers/conditional_image_generation))或看[**Pipelines**](#pipelines) 以获取所有支持的pipeline及其对应的论文的概述。
...
**注意**: Pipelines是如何使用相应论文中提出的扩散模型的简单示例。