...
- **투명성**: PR 관리, 사용자에게 선택 사항을 설명하고 기술적 결정을 내리는 데 있어서 투명성을 유지하는 것에 약속합니다.

- **일관성**: 프로젝트 관리에서 사용자에게 동일한 수준의 주의를 보장하고 기술적으로 안정하고 일관성 있게 유지하는 것에 약속합니다.

- **간결성**: Diffusers 라이브러리를 사용하고 활용하기 쉽게 만들기 위해 프로젝트의 목표를 간결하고 일관성 있게 유지하는 것에 약속합니다.
