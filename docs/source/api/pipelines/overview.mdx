...
- [`from_pretrained` method](../diffusion_pipeline) that accepts a Hugging Face Hub repository id, *e.g.* [runwayml/stable-diffusion-v-1-5](https://huggingface.co/runwayml/stable-diffusion-v-1-5) or a path to a local directory, *e.g.*
