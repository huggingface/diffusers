...
Long story short: Head over to your stable diffusion model of choice, *e.g.* [`runwayml/stable-diffusion-v-1-5`](https://huggingface.co/runwayml/stable-diffusion-v-1-5), read through the license and click-accept to get 
access to the model. 
...
You can then load [`runwayml/stable-diffusion-v-1-5`](https://huggingface.co/runwayml/stable-diffusion-v-1-5) 
