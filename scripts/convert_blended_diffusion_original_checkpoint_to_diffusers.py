...
if __name__ == "__main__":
    ...
    # TODO: remove
    args.checkpoint_path = "../blended-diffusion/256x256_diffusion_uncond.pt"
    args.config_file = "../ddpm_256_custom_config.json"
    args.dump_path = "../blended-diffusion/converted_256x256_diffusion_uncond.pt"
