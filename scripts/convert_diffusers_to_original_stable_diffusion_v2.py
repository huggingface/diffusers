...
textenc_conversion_map = {x[1]:x[0] for x in textenc_conversion_lst}
protected = dict((re.escape(k), v) for k, v in textenc_conversion_map.items()) 
print("REGEX:","|".join(protected.keys()))
