...
if not args.skip_stage_c:
    ...
    prior_state_dict = get_conversion("StableCascadeUNet", dict(prior_model.config)).to_diffusers(
...
if not args.skip_stage_b:
    ...
    decoder_state_dict = get_conversion("StableCascadeUNet", dict(decoder.config)).to_diffusers(
