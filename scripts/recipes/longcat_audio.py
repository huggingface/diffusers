...
# Usage:
#   python scripts/recipes/longcat_audio.py --checkpoint_path /path/to/model --output_path /data/models
#   python scripts/recipes/longcat_audio.py --repo_id meituan-longcat/LongCat-AudioDiT-1B --output_path /data/models
#   python scripts/recipes/longcat_audio.py --checkpoint_path /path/to/model --output_path /data/models --dtype fp16
...
def convert_longcat_audio_dit(
    ...
    transformer.load_state_dict(
        get_conversion("LongCatAudioDiTTransformer", dict(transformer.config)).to_diffusers(transformer_state_dict),
        strict=True,
    )
    ...
    vae.load_state_dict(
        get_conversion("LongCatAudioDiTVae", dict(vae.config)).to_diffusers(vae_state_dict), strict=True
    )
