...
def convert_transformer(
    ...
    original_state_dict = load_state_dict(ckpt_path)
    ...
    converted = convert_cogvideox_transformer_checkpoint_to_diffusers(original_state_dict, transformer.config)
...
def convert_vae(ckpt_path: str, scaling_factor: float, version: str, dtype: torch.dtype):
    ...
    converted = convert_cogvideox_vae_checkpoint_to_diffusers(original_state_dict, vae.config)
