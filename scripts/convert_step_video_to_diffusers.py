...
def convert_transformer(model_type: str, stage: str = None):
    ...
    with init_empty_weights():
        transformer = StepVideoTransformer3DModel.from_config(diffusers_config)
