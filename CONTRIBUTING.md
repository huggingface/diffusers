...
make a commit with `git commit` to record your changes locally:
 ...
 $ git commit -m "A descriptive message about what I've done"
 ```
...
For documentation strings, 🧨 Diffusers follows the [Google Python Style](https://google.github.io/styleguide/pyguide.html).
