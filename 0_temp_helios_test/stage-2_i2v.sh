CUDA_VISIBLE_DEVICES=0 python infer_helios.py \
    --base_model_path "/mnt/bn/yufan-dev-my/ysh_new/Codes/Helios/1_formal_ckpts/Helios-Mid" \
    --transformer_path "/mnt/bn/yufan-dev-my/ysh_new/Codes/Helios/1_formal_ckpts/Helios-Mid" \
    --sample_type "i2v" \
