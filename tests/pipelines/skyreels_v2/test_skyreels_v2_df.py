...
class SkyReelsV2DiffusionForcingPipelineFastTests(PipelineTesterMixin, unittest.TestCase):
    ...
    def get_dummy_components(self):
        ...
        torch.manual_seed(0)
        scheduler = FlowMatchUniPCMultistepScheduler(shift=7.0)
...
@slow
@require_torch_accelerator
class SkyReelsV2DiffusionForcingPipelineIntegrationTests(unittest.TestCase):
    ...
    def test_SkyReelsV2DiffusionForcingx(self):
        pass
