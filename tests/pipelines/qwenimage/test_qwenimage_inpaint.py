...
class QwenImageInpaintPipelineTesterConfig(BasePipelineTesterConfig):
...
class TestQwenImageInpaintPipeline(QwenImageInpaintPipelineTesterConfig, PipelineTesterMixin):
...
class TestQwenImageInpaintPipelineMemory(QwenImageInpaintPipelineTesterConfig, MemoryTesterMixin):
    pass
