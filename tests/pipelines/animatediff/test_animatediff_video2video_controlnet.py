...
class TestAnimateDiffVideoToVideoControlNetPipelineFromPipe(
    AnimateDiffVideoToVideoControlNetPipelineTesterConfig, FromPipeTesterMixin
):
    """`from_pipe` round-trip tests against `StableDiffusionPipeline` for the AnimateDiff video-to-video ControlNet pipeline."""
