...
class SanaControlNetPipelineTesterConfig(BasePipelineTesterConfig):
    ...
    def get_dummy_inputs(self):
        ...
        control_image = randn_tensor((1, 3, 32, 32), generator=generator, device=torch.device("cpu"))
        return {
            "prompt": "",
            "negative_prompt": "",
            "generator": generator,
...
class TestSanaControlNetPipeline(SanaControlNetPipelineTesterConfig, PipelineTesterMixin):
...
class TestSanaControlNetPipelineMemory(SanaControlNetPipelineTesterConfig, MemoryTesterMixin):
    """Memory optimization tests (CPU offload, group offload, layerwise casting) for the Sana ControlNet pipeline."""
