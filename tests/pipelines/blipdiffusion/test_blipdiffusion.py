...
class BlipDiffusionPipelineFastTests(PipelineTesterMixin, unittest.TestCase):
    ...
    def dummy_qformer(self):
        ...
        blip_config = Blip2Config(vision_config=vision_config, qformer_config=qformer_config, num_query_tokens=16)
        qformer = Blip2QFormerModel(blip_config)
        return qformer
