...
from diffusers import BlipDiffusionControlNetPipeline, PNDMScheduler, UNet2DConditionModel, AutoencoderKL, ControlNetModel
...
class BlipDiffusionControlNetPipelineFastTests(PipelineTesterMixin, unittest.TestCase):
    ...
    def test_blipdiffusion_controlnet(self):
        ...
        expected_slice = np.array(
           [0.2627,  0.4980, 0.5529, 0.4823, 0.2862, 0.5333, 0.3254,  0.5960, 0.5176]
        )
