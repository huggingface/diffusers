...
from diffusers import DDPMScheduler, IFImg2ImgSuperResolutionPipeline, UNet2DConditionModel
...
class IFImg2ImgSuperResolutionPipelineTesterConfig(BasePipelineTesterConfig):
    ...
    batch_input_params = frozenset(["prompt", "image", "negative_prompt", "original_image"])
...
@skip_mps
class TestIFImg2ImgSuperResolutionPipeline(IFImg2ImgSuperResolutionPipelineTesterConfig, PipelineTesterMixin):
    def test_inference(self):
        ...
        # fmt: off
        expected_slice = torch.tensor([0.8381, 0.7539, 0.4202, 0.2587, 0.5238, 0.4147, 0.7804, 0.2934, 0.2991, 0.7971, 0.3377, 0.1736, 0.9627, 0.7004, 0.7934, 0.4913])
        # fmt: on
...
@skip_mps
class TestIFImg2ImgSuperResolutionPipelineMemory(
    IFImg2ImgSuperResolutionPipelineTesterConfig, PipelineOffloadTesterMixin
):
    pass
...
@slow
@require_torch_accelerator
class TestIFImg2ImgSuperResolutionPipelineSlow:
