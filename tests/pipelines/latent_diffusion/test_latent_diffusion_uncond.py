...
class LDMPipelineFastTests(unittest.TestCase):
    ...
    def test_inference_uncond(self):
        ...
        from diffusers.utils.testing_utils import print_tensor_test; print_tensor_test(image_slice); assert np.abs(image_slice.flatten() - expected_slice).max() < tolerance
