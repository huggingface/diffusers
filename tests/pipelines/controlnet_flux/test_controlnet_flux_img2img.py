...
class TestFluxControlNetImg2ImgPipeline(FluxControlNetImg2ImgPipelineTesterConfig, PipelineTesterMixin):
    ...
    def test_flux_controlnet_img2img_true_cfg(self):
        pipe = self.get_pipeline().to(torch_device)
    ...
    def test_flux_controlnet_img2img_true_cfg_requires_negative_prompt(self):
    ...
    def test_flux_controlnet_img2img_true_cfg_with_negative_embeds(self):
        pipe = self.get_pipeline().to(torch_device)
