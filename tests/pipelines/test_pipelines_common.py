...
class PipelineLatentTesterMixin:
    ...
    def test_latents_input(self):
        ...
        out = pipe(**self.get_dummy_inputs_by_type(torch_device, input_image_type="pt"))[0] # torch 
        ...
        for image_param in self.image_params:
            if image_param in inputs.keys():
                inputs[image_param] = vae.encode(inputs[image_param]).latent_dist.sample(generator) * vae.config.scaling_factor
