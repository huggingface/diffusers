...
class StableDiffusionXLControlNetInpaintPipelineFastTests(PipelineLatentTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    def test_stable_diffusion_xl_controlnet_inpaint_negative_prompt_embeds(self):
        components = self.get_dummy_components()
        sd_pipe = StableDiffusionXLControlNetInpaintPipeline(**components)
    ...
    def test_stable_diffusion_xl_offloads(self):
        pipes = []
        components = self.get_dummy_components()
        sd_pipe = StableDiffusionXLControlNetInpaintPipeline(**components).to(torch_device)
    ...
    def test_stable_diffusion_two_xl_mixture_of_denoiser(self):
        components = self.get_dummy_components()
        pipe_1 = StableDiffusionXLControlNetInpaintPipeline(**components).to(torch_device)
        pipe_1.unet.set_default_attn_processor()
        pipe_2 = StableDiffusionXLControlNetInpaintPipeline(**components).to(torch_device)
    ...
    def test_stable_diffusion_three_xl_mixture_of_denoiser(self):
        ...
        pipe_2 = StableDiffusionXLControlNetInpaintPipeline(**components).to(torch_device)
        pipe_2.unet.set_default_attn_processor()
        pipe_3 = StableDiffusionXLControlNetInpaintPipeline(**components).to(torch_device)
