...
KREA2_WORKFLOWS = {
    ...
    "image2image": [
        ...
        ("denoise.input.text_inputs", "Krea2TextInputsStep"),
    ...
    "inpainting": [
        ...
        ("denoise.prepare_position_ids", "Krea2PreparePositionIdsStep"),
        ("denoise.denoise", "Krea2InpaintDenoiseStep"),
        ("decode", "Krea2InpaintDecodeStep"),
    ],
    "reference": [
        ("text_encoder", "Krea2ReferenceTextEncoderStep"),
        ...
        ("denoise.denoise", "Krea2ReferenceDenoiseStep"),
        ("decode", "Krea2DecodeStep"),
    ],
}
