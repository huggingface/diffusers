...
from ..test_components_manager import ComponentsManagerTesterMixin, ModularPipelineOffloadTesterMixin
...
class TestFluxModularPipelineFast(
    ComponentsManagerTesterMixin,
    ModularPipelineOffloadTesterMixin,
