                ...
                Expectations(
                    {
                        ...
                        ("mps", None): torch.tensor([-0.1603, 0.9878, -0.0495, -0.0790, -0.2709, 0.8375, -0.2060, -0.0824]),
                    }
                ),
            ],
            [
                ...
                Expectations(
                    {
                        ...
                        ("mps", None): torch.tensor([-0.2376, 0.1168, 0.1332, -0.4840, -0.2508, -0.0791, -0.0493, -0.4089]),
                    }
                ),
            ],
            # fmt: on
