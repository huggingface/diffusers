...
class TestHeliosTransformer3DBitsAndBytes(HeliosTransformer3DTesterConfig, BitsAndBytesTesterMixin):
    """BitsAndBytes quantization tests for Helios Transformer 3D."""
...
class TestHeliosTransformer3DTorchAo(HeliosTransformer3DTesterConfig, TorchAoTesterMixin):
    """TorchAO quantization tests for Helios Transformer 3D."""
...
# class TestHeliosTransformer3DGGUF(HeliosTransformer3DTesterConfig, GGUFTesterMixin):
#     """GGUF quantization tests for Helios Transformer 3D."""
...
#             config_kwargs, config="BestWishYsh/Helios-Base", subfolder="transformer", **extra_kwargs
#         )


# class TestHeliosTransformer3DGGUFCompile(HeliosTransformer3DTesterConfig, GGUFCompileTesterMixin):
#     """GGUF + compile tests for Helios Transformer 3D."""
