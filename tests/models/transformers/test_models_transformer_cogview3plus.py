...
class TestCogView3PlusTransformerMemory(CogView3PlusTransformerTesterConfig, MemoryTesterMixin):
    pass


class TestCogView3PlusTransformerAttention(CogView3PlusTransformerTesterConfig, AttentionTesterMixin):
    pass
