...
class Lumina2AccessoryTransformer2DModelTransformerTests(ModelTesterMixin, unittest.TestCase):
    model_class = Lumina2AccessoryTransformer2DModel
    ...
    def test_gradient_checkpointing_is_applied(self):
        expected_set = {"Lumina2AccessoryTransformer2DModel"}
