...
class PipelineTesterMixin:
    ...
    def params(self) -> frozenset:
        raise NotImplementedError(
            ...
            "`params` are checked if they can be passed to `__call__`. "
            "`params` are used for families of pipelines that have common parameters such as text to "
            "image pipelines for prompts and prompt embedding overrides. `pipeline_params.py` provides "
            "some common sets of parameters such as `TEXT_TO_IMAGE_PARAMS`, `IMAGE_VARIATION_PARAMS`, etc... "
