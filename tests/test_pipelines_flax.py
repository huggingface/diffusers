...
class FlaxPipelineTests(unittest.TestCase):
    ...
    def test_stable_diffusion_v1_4(self):
        pipeline, params = FlaxStableDiffusionPipeline.from_pretrained(
            "runwayml/stable-diffusion-v-1-5", revision="flax", safety_checker=None
        )
    ...
    def test_stable_diffusion_v1_4_bfloat_16(self):
        pipeline, params = FlaxStableDiffusionPipeline.from_pretrained(
            "runwayml/stable-diffusion-v-1-5", revision="bf16", dtype=jnp.bfloat16, safety_checker=None
        )
    ...
    def test_stable_diffusion_v1_4_bfloat_16_with_safety(self):
        pipeline, params = FlaxStableDiffusionPipeline.from_pretrained(
            "runwayml/stable-diffusion-v-1-5", revision="bf16", dtype=jnp.bfloat16
        )
