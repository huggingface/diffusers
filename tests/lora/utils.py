...
class PeftLoraLoaderMixinTests:
    ...
    def get_base_pipeline_outputs(self):
        ...
        self.cached_non_lora_output["base"] = pipe(**inputs, generator=torch.manual_seed(0))[0]

        # Ensures that there's no inconsistency when reusing the cache.
        yield
        self.cached_non_lora_output.clear()
    ...
    def test_simple_inference(self):
        ...
        """
        output_no_lora = self.cached_non_lora_output["base"]
