...
def main(args):
    ...
    unet.up_blocks[-1].requires_grad_(True)
    ...
    params_to_train = itertools.chain(
        ...
        unet.up_blocks[-1].parameters(),
        unet.conv_norm_out.parameters(),
            ...
            with accelerator.accumulate(controlnet):
                ...
                if accelerator.sync_gradients:
                    params_to_clip = itertools.chain(
                        controlnet.parameters(), 
                        unet.module.up_blocks[-1].parameters(),
                        unet.module.conv_norm_out.parameters(),
                        unet.module.conv_out.parameters()
                    )
